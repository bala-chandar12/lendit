...
export default function Card(params: any) {
    ...
    return (
      ...
      >
        ...
        <MyCard maxW='md' boxShadow='lg' p='6' rounded='md' bg='white'>
        <CardHeader>
            <Flex gap='4'>
    ...
    >
            ...
            <AlertDialogContent>
            <AlertDialogHeader>Current price ${cost}</AlertDialogHeader>
            <AlertDialogCloseButton />
            <AlertDialogBody>
                Are you sure you want to borrow this item for the $100?
            </AlertDialogBody>
            <AlertDialogFooter>
